export default function SettingsPage() {
  return (
    <div>
      <h1 className="text-3xl font-serif text-[#2C2C2C] mb-2">Settings</h1>
      <p className="text-[#6B6B6B] mb-8">Change your password and account settings</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-[#E5E5E5] p-8 text-center">
        ...
        <p className="text-[#6B6B6B]">
          Settings and password change will be available here soon.
        </p>
      </div>
    </div>
  );
