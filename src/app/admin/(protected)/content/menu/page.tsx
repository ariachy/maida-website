export default function ContentMenuPage() {
  return (
    <div>
      <h1 className="text-3xl font-serif text-[#2C2C2C] mb-2">Menu Content</h1>
      <p className="text-[#6B6B6B] mb-8">Edit menu items and categories in English and Portuguese</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-[#E5E5E5] p-8 text-center">
        ...
        <p className="text-[#6B6B6B]">
          Menu editors will be available here soon.
        </p>
      </div>
    </div>
  );
