export default function ContentStoryPage() {
  return (
    <div>
      <h1 className="text-3xl font-serif text-[#2C2C2C] mb-2">Story Page Content</h1>
      <p className="text-[#6B6B6B] mb-8">Edit the About/Story page in English and Portuguese</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-[#E5E5E5] p-8 text-center">
        ...
        <p className="text-[#6B6B6B]">
          Story page editors will be available here soon.
        </p>
      </div>
    </div>
  );
